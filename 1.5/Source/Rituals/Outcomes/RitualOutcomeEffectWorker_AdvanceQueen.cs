...
{
    public class RitualOutcomeEffectWorker_AdvanceQueen : RitualOutcomeEffectWorker_FromQuality
    {
        public RitualOutcomeEffectWorker_AdvanceQueen()
        {
        }

        public RitualOutcomeEffectWorker_AdvanceQueen(RitualOutcomeEffectDef def)
            : base(def)
        {
        }
        ...
        public override void Apply(float progress, Dictionary<Pawn, int> totalPresence, LordJob_Ritual jobRitual)
        {
            ...
            Pawn queen = jobRitual.PawnWithRole("queen");

            if (queen == null)
            {
                Log.Error("No Queen on finished Queen Advancement Ritual");
                return;
            }
            ...
            {
                ritualJobDriver.DynamicBodyOffset.y = 0;
            }
